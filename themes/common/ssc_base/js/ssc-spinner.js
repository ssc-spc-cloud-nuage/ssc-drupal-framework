...
(function ($, Drupal) {
  Drupal.behaviors.sscSpinner = {
    attach: function (context, settings) {
      // Implement custom full-screen progress indicator
      Drupal.theme.ajaxProgressIndicatorFullscreen = function () {
        return $(`
          <div class="ssc-spinner ssc-spinner--fullscreen" aria-hidden="true">
            <svg viewBox="0 0 94.45 100" class="ssc-spinner-icon">
              ...
              <path d="M47.9,86.74c-3.65,0-6.63,2.98-6.63,6.63s2.98,6.63,6.63,6.63,6.63-2.98,6.63-6.63-2.98-6.63-6.63-6.63h0Z"/>
            </svg>
          </div>
        `);
      };
